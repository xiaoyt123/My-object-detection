...
if (__name__ == "__main__"):
    # print("main")
    basePath = "My-object-detection/data/DETRAC-Train-Annotations-XML"
    totalxml = os.listdir(basePath)
    total_num = 0
    flag = False
    print("正在转换")
    saveBasePath = "My-object-detection/data/xml_test"
    ...
    visualization_image("My-object-detection/data/Insight-MVT_Annotation_Train/MVI_40212/img00396.jpg", "My-object-detection/data/xml_test/MVI_40212__img00396.xml")